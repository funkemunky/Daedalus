            ...
            if (this.Daedalus.getAutobanQueue().contains(player)) {
                ...
                switch (lowerCase = type.toLowerCase()) {
                    case "cancel": {
                        ...
                        Bukkit.broadcast(ChatColor.translateAlternateColorCodes('&', Daedalus.PREFIX + Daedalus.getConfig().getString("alerts.secondary") + player.getName() + Daedalus.getConfig().getString("alerts.primary") + "'s auto-ban has been cancelled by " + Daedalus.getConfig().getString("alerts.secondary") + sender.getName()), "daedalus.staff");
                        break;
                    }
                    case "ban": {
                       if(this.Daedalus.getConfig().getBoolean("testmode") == true) {
                           ...
                           Bukkit.broadcast(ChatColor.translateAlternateColorCodes('&', Daedalus.PREFIX + Daedalus.getConfig().getString("alerts.secondary") + player.getName() + Daedalus.getConfig().getString("alerts.primary") + "'s auto-ban has been forced by " + Daedalus.getConfig().getString("alerts.secondary") + sender.getName()), "daedalus.staff");
