...
public class UtilActionMessage
{
    ...
    public void sendToPlayer(Player Player)
    {
        try {
        	...
        	Constructor<?> titleConstructor = getNMSClass("PacketPlayOutChat").getConstructor(getNMSClass("IChatBaseComponent"));
        	if(version.contains("1_7") || version.contains("1_8_R1")) {
        		...
        		base = getNMSClass("IChatBaseComponent").getDeclaredClasses()[0].getMethod("a", String.class).invoke(null, getFormattedMessage());
        	}
