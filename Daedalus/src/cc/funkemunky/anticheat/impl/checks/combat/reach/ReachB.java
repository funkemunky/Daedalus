...
public class ReachB extends Check {
    ...
    public void onPacket(Object packet, String packetType, long timeStamp) {
        ...
        val entityData = target.getType().equals(EntityType.PLAYER) ? Daedalus.getInstance().getDataManager().getPlayerData(target.getUniqueId()) : null;
    ...
    private BoundingBox getHitbox(EntityType type, CustomLocation l) {
        ...
        return new BoundingBox(minX, minY, minZ, maxX, maxY, maxZ).grow(.35f, 0.35f, .35f);
    }
}
