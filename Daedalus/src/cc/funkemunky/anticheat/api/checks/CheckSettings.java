...
public class CheckSettings {
    ...
    static List<String> executableCommand = Collections.singletonList("kick %player% [DAEDALUS] You have been kicked for failing %check%");

    @ConfigSetting(name = "key")
    public static String key = "";

    @ConfigSetting(path = "alerts", name = "alertMessage")
    static String alertMessage = "&8[&c&lDaedalus&8] &f%player% &7has failed &f%check% &c(x%vl%)";
