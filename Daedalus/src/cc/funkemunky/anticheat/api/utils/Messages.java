...
public class Messages {
    ...
    @Message(name = "prefix")
    public static String prefix = "&8[&c&lDaedalus&8]";
    ...
    public static String secondaryColor = "&c";
    ...
    public static String invalidArguments = "Invalid arguments. Check the Daedalus help page for more information.";
    ...
    public static String startReloading = "Fully reloading Daedalus...";
